...
from apps.products.api.views.general_views import MeasureUnitListAPIView,IndicatorListAPIView,CategoryProductAPIView
...
urlpatterns = [
   ...
   #path('category_product/',CategoryProductAPIView.as_view(), name = 'category_product'),
